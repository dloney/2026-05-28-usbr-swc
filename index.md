...
address: "Hungry Horse Room, Building 67, Denver Federal Center"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "May 28-29, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00am - 5:00pm MT"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2026-05-28      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
...
helper: ["Frankie Nuffer-Rodriguez"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p id="requirements">
  ...
  {% if online == "false" %}
    Participants must bring a Windows laptop that they have standard user permissions on. No admin level access in necessary.
  {% else %}
